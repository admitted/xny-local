...
//	==================通信========================================================
	...
	public static final int COMM_SUBMMIT 					= 0x00000004;	//客户端提交  上行
	public static final int COMM_DELIVER 					= 0x00000005;	//服务器派发  下行
...
//	==========================AppSvr ~ CPM========================================
	public static final int CMD_SUBMIT_1000	 		 	    = 1000;         //设备状态上传
	public static final int CMD_SUBMIT_1001	 				= 1001;         //环境数据上传
	public static final int CMD_SUBMIT_1003	 				= 1003;         //联动记录上传
	public static final int CMD_SUBMIT_1004	 				= 1004;         //告警数据上传
